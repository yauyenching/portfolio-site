    ...
    return (
      ...
      >
        <Flex
          ...
          opacity={0.55}
        />
        <Heading as='h2' fontSize='lg' position='absolute' m='auto' color='brand.title'>
          {designTitle}
        </Heading>
      </GridItem>
    )
  ...
  return (
    <Box w='100%'>
      ...
      <Grid
        ...
        columnGap={15}
      >
        <DesignsCard designTitle='Homemates' imageFileName='homemates.png' />
        <DesignsCard designTitle='Gifter' imageFileName='gifter.png' />
        <DesignsCard designTitle='2020 W3Schools Redesign' imageFileName='w3schools.png' />
      </Grid>
    </Box>
  )
}
