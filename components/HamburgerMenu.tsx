...
export default function HamburgerMenu({ onOpen, isOpen }: WithRequired<UseDisclosureProps, "onOpen">) {
  return (
    <Box stroke='brand.body'>
      <svg className={"ham hamRotate ham8".concat(isOpen ? " active" : "")} viewBox="0 0 100 100" width="40" onClick={(e) => onOpen()}>
        <path
          className="line top"
